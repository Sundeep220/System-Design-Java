...
public class ReportDocument implements Document {
    ...
    public ReportDocument(String title) {
        ...
        this.body = new Body("Quarterly financial report and performance metrics.");
        this.footer = new Footer("Finance Dept", "Approved");
        this.metaData = new MetaData("System", "Finance");
    }

    private ReportDocument(ReportDocument original) {
