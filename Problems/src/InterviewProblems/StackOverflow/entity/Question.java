...
public class Question extends Post {
    ...
    private final List<Basics.StackOverflow.entity.Tag> tags;
    private final List<Basics.StackOverflow.entity.Answer> answers;
    ...
    public void addTag(Basics.StackOverflow.entity.Tag tag) {
    ...
    public void addAnswer(Basics.StackOverflow.entity.Answer answer) {
        answers.add(answer);
    }
